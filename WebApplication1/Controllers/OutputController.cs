...
namespace WebApplication1.Controllers
{
    ...
    [HttpGet("{id}")]
        ...
        public HttpResponseMessage Post(Employee employee)
        {
            try
            {
                _procedures.POSTAsync(employee.Emp_ID, employee.Emp_Name, employee.Designation, employee.Location,employee.Doj, employee.Lwd,employee.Email_ID,employee.Vertical_L2,employee.Rm_Emp_ID,employee.Band,employee.Level,employee.Role_ID);
